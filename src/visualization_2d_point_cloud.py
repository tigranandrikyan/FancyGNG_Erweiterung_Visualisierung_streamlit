...
# Erstelle eine 3D-Figur und zeige die Punktewolken mit Farben an
fig = plt.figure(figsize=(12, 8))

# Subplot 1: 3D-Punktewolke für Bild 1
ax1 = fig.add_subplot(121)
ax1.scatter(points1[:, 1], points1[:, 2],  c=points1[:, 3:6]/255, s=1)
ax1.set_xlabel("G")
ax1.set_ylabel("B")
ax1.set_xlim(0, 255)
ax1.set_ylim(0, 255)
...
ax2.scatter(points2[:, 1], points2[:, 2], c=points2[:, 3:6]/255, s=1)
ax2.set_xlabel("G")
ax2.set_ylabel("B")
ax2.set_xlim(0, 255)
ax2.set_ylim(0, 255)
